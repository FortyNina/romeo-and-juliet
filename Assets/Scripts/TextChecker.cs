...
namespace ShakespeareReader
{
	public class TextChecker : MonoBehaviour
	{
		...
		//GOODS========================================================================================
		public static bool CheckGood(string s)
		{
			return CheckAgainstAText(s, TextReader.GoodLines);
		}
		public static bool CheckGoodContains(string s)
		{
			return CheckAgainstATextContains(s, TextReader.GoodLines);
		}

		//BADS========================================================================================
		public static bool CheckBad(string s)
		{
			return CheckAgainstAText(s, TextReader.BadLines);
		}
		public static bool CheckBadContains(string s)
		{
			return CheckAgainstATextContains(s, TextReader.BadLines);
		}
